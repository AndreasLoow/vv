...
// Compare with double_wait_blocking,
// awkward that they differ...
...
// Compare with double_wait_nonblocking,
// awkward that they differ...
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(x,C){var R=x.length;x.push(C);e:for(;0<R;){var O=R-1>>>1,V=x[O];if(0<i(V,C))x[O]=C,x[R]=V,R=O;else break e}}function t(x){return x.length===0?null:x[0]}function r(x){if(x.length===0)return null;var C=x[0],R=x.pop();if(R!==C){x[0]=R;e:for(var O=0,V=x.length,Tn=V>>>1;O<Tn;){var He=2*(O+1)-1,Nn=x[He],Oe=He+1,Cn=x[Oe];if(0>i(Nn,R))Oe<V&&0>i(Cn,Nn)?(x[O]=Cn,x[Oe]=R,O=Oe):(x[O]=Nn,x[He]=R,O=He);else if(Oe<V&&0>i(Cn,R))x[O]=Cn,x[Oe]=R,O=Oe;else break e}}return C}function i(x,C){var R=x.sortIndex-C.sortIndex;return R!==0?R:x.id-C.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,u=l.now();e.unstable_now=function(){return l.now()-u}}var a=[],s=[],v=1,p=null,m=3,h=!1,y=!1,w=!1,z=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(x){for(var C=t(s);C!==null;){if(C.callback===null)r(s);else if(C.startTime<=x)r(s),C.sortIndex=C.expirationTime,n(a,C);else break;C=t(s)}}function _(x){if(w=!1,f(x),!y)if(t(a)!==null)y=!0,Se(S);else{var C=t(s);C!==null&&he(_,C.startTime-x)}}function S(x,C){y=!1,w&&(w=!1,d(g),g=-1),h=!0;var R=m;try{for(f(C),p=t(a);p!==null&&(!(p.expirationTime>C)||x&&!H());){var O=p.callback;if(typeof O=="function"){p.callback=null,m=p.priorityLevel;var V=O(p.expirationTime<=C);C=e.unstable_now(),typeof V=="function"?p.callback=V:p===t(a)&&r(a),f(C)}else r(a);p=t(a)}if(p!==null)var Tn=!0;else{var He=t(s);He!==null&&he(_,He.startTime-C),Tn=!1}return Tn}finally{p=null,m=R,h=!1}}var N=!1,E=null,g=-1,I=5,P=-1;function H(){return!(e.unstable_now()-P<I)}function te(){if(E!==null){var x=e.unstable_now();P=x;var C=!0;try{C=E(!0,x)}finally{C?Ee():(N=!1,E=null)}}else N=!1}var Ee;if(typeof c=="function")Ee=function(){c(te)};else if(typeof MessageChannel<"u"){var tn=new MessageChannel,se=tn.port2;tn.port1.onmessage=te,Ee=function(){se.postMessage(null)}}else Ee=function(){z(te,0)};function Se(x){E=x,N||(N=!0,Ee())}function he(x,C){g=z(function(){x(e.unstable_now())},C)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(x){x.callback=null},e.unstable_continueExecution=function(){y||h||(y=!0,Se(S))},e.unstable_forceFrameRate=function(x){0>x||125<x?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):I=0<x?Math.floor(1e3/x):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(a)},e.unstable_next=function(x){switch(m){case 1:case 2:case 3:var C=3;break;default:C=m}var R=m;m=C;try{return x()}finally{m=R}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(x,C){switch(x){case 1:case 2:case 3:case 4:case 5:break;default:x=3}var R=m;m=x;try{return C()}finally{m=R}},e.unstable_scheduleCallback=function(x,C,R){var O=e.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?O+R:O):R=O,x){case 1:var V=-1;break;case 2:V=250;break;case 5:V=1073741823;break;case 4:V=1e4;break;default:V=5e3}return V=R+V,x={id:v++,callback:C,priorityLevel:x,startTime:R,expirationTime:V,sortIndex:-1},R>O?(x.sortIndex=R,n(s,x),t(a)===null&&x===t(s)&&(w?(d(g),g=-1):w=!0,he(_,R-O))):(x.sortIndex=V,n(a,x),y||h||(y=!0,Se(S))),x},e.unstable_shouldYield=H,e.unstable_wrapCallback=function(x){var C=m;return function(){var R=m;m=C;try{return x.apply(this,arguments)}finally{m=R}}}})(Pd);Ad.exports=Pd;var k0=Ad.exports;/**
 * @license React
